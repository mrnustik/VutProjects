...
void memoryInit()
{
    globalMemory = (tGlobalMemory*) malloc(sizeof(tGlobalMemory));
...
void* mMalloc(unsigned long size)
{
    ...
    {
        globalMemory->First = globalMemory->Last = (tAllocUnit*) malloc(sizeof(tAllocUnit));
    }
    else
    {
        globalMemory->Last->next = (tAllocUnit*) malloc(sizeof(tAllocUnit));
