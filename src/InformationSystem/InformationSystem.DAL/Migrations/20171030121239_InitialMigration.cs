    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CarIdentification = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsedMaterialEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsedMaterialEntity_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsedMaterialEntity_Repairs_RepairId",
                        column: x => x.RepairId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsedMaterialEntity_MaterialId",
                table: "UsedMaterialEntity",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_UsedMaterialEntity_RepairId",
                table: "UsedMaterialEntity",
                column: "RepairId");
        }
