package net.mrnustik.university.solitaire.view.view;
...
public class CardView extends JButton {
    ...
    public Icon getIcon() {
        ...
        if (mCard == null)
            ...
            resource = getClass().getResource("/net/mrnustik/university/solitaire/view/images/" + mCard.toString() + ".png");
        else {
            if (!shouldRedraw() && scaledBackIcon != null) return scaledBackIcon;
            resource = getClass().getResource("/net/mrnustik/university/solitaire/view/images/CARD_BACK.png");
        }
        if (resource != null)
            if (shouldRedraw()) {
